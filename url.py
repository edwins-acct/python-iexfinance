...
for ticker in sorted(symbolsList):
	try:
		...
		extChgPct = "{:.2%}".format(parsed[ticker]['quote']['changePercent'])
		if ext == 1:
			print(f"{ticker:<10}{price:>10}{change:>10}{chgPct:>10}{chgYtd:>15}{vol:>15}{avgVol:>15}{chgVol:>8}{mktCap:>10}{extPrice:>10}{extChgPct:>10}")
		else:
